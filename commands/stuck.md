...
1. Stop the loop. Say:
   "We've been on this for a while. I'm going to name the real decision.
...
3. State the two (max three) real options. One line each.
   No sub-bullets. No caveats. Just the options.

4. State the consequence of each in one sentence.
   Not "it depends." A real consequence.

5. Make a recommendation.
   "I'd go with [option] because [one reason]."
...
8. After 3 rounds of back-and-forth with no close:
   ...
   but I need a decision right now."
...
Options:
A. [option] → consequence: [one sentence]
B. [option] → consequence: [one sentence]

My call: [A or B] — [one reason]
